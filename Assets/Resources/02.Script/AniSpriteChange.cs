...
public class AniSpriteChange : MonoBehaviour {
    ...
    void Start () {
        ...
        //SetAnimation("RUN", false, 1f);
    }
    //void Update()
    //{
        //if (Input.GetKeyDown(KeyCode.F))
        //{
           // currentThema = currentThema == 0 ? 1 : 0;
           // SpriteChange();
            /*if(currentThema == 1)
    ...
    public void SpriteChange()
    {
        ...
        currentName = currentThema == 1 ? Thema01 : Thema02;
        ...
        {
            //int temp = data.FindSlotIndex("uniform/skin_hat");//유니폼 입었을때 모자 처리
            //mySkin.AddAttachment(temp, null, AttachmentSource.GetAttachment(temp, null));
        }
